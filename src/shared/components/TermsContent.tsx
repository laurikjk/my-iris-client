export default function TermsContent() {
  return (
    <>
      ...
      <p className="mb-3">
        <strong>
          IMPORTANT: PLEASE READ CAREFULLY. BY USING THIS APPLICATION, YOU AGREE TO THESE TERMS.
        </strong>
      </p>
      ...
      <p className="mb-3">
        You interact directly with third-party Cashu mints who act as custodians. We have no
        control over, responsibility for, or liability regarding any mint's operation,
        reliability, or solvency.
      </p>

      <h3 className="font-bold mb-2 text-white">5. No Liability for Lost Funds</h3>
      <p className="mb-3">
        <strong>YOU ASSUME ALL RISKS OF FINANCIAL LOSS.</strong> We are not responsible for any
      ...
      <p className="mb-3">
        <strong>Iris Username Service:</strong> If you register an iris.to username, we collect
