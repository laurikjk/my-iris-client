      ...
      return (
        <div className="p-2">
          <div className="max-w-md md:max-w-lg lg:max-w-xl overflow-x-scroll">
            ...
            <p className="break-all whitespace-pre font-mono text-sm">Error: {this.state.errorMessage}</p>
            <pre className="text-xs mt-8 break-all whitespace-pre font-mono">{this.state.stack}</pre>
          </div>
        </div>
      )
    }
