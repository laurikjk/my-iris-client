  ...
  return (
    <>
      <div
        ...
        className="flex flex-col flex-1 space-y-4 p-4 relative overflow-y-auto pt-[calc(4rem+env(safe-area-inset-top))] pb-[calc(8rem+env(safe-area-inset-bottom))] md:pt-4 md:pb-4"
