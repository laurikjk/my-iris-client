...
describe("mapImetaTag", () => {
  it("should map a single key-value pair correctly", () => {
  ...
  it("should map multiple key-value pairs correctly", () => {
  ...
  it("should handle fallback as an array", () => {
    const tag: NDKTag = [
      "imeta",
  ...
  it("should handle mixed key-value pairs with fallbacks", () => {
    const tag: NDKTag = [
      "imeta",
  ...
  it("should return an empty object for an empty tag", () => {
    const tag: NDKTag = []
    const result = mapImetaTag(tag)
    const expected: NDKImetaTag = {}
    expect(result).toEqual(expected)
  ...
  it("should process duplicate keys and overwrite previous values", () => {
