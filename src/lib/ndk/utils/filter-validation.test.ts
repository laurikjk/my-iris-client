    ...
    describe("bech32 in tag filters", () => {
      ...
      it("should throw fatal error for non-addressable kind in #a tag filter", () => {
        const badFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "20:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:undefined",
          ],
        }
      ...
      it("should throw for kind 1 in #a tag", () => {
        const badFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "1:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:test",
          ],
        }
      ...
      it("should throw for kind 29999 (just below addressable range) in #a tag", () => {
        const badFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "29999:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:test",
          ],
        }
      ...
      it("should throw for kind 40000 (just above addressable range) in #a tag", () => {
        const badFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "40000:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:test",
          ],
        }
      ...
      it("should allow valid addressable kind 30000 in #a tag", () => {
        const goodFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "30000:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:test",
          ],
        }
      ...
      it("should allow valid addressable kind 30023 (article) in #a tag", () => {
        const goodFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "30023:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:my-article",
          ],
        }
      ...
      it("should allow valid addressable kind 39999 (max range) in #a tag", () => {
        const goodFilter: NDKFilter = {
          kinds: [1],
          "#a": [
            "39999:fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52:test",
          ],
        }
      ...
      it("should catch invalid pubkeys from kind:3 follow lists", () => {
        ...
        try {
          ...
          expect(error.message).toContain(
            "Kind:3 follow lists can contain invalid entries"
          )
